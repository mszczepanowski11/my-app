...
export const Reviews:FC<IEditable> = (props) => {
    ...
    const [edit,setEdit] = useState({
        ...
        date_one:JSON.stringify(currentDate),
        date_two:JSON.stringify(currentDate),
        date_three:JSON.stringify(currentDate),
    ...
    return(
        <ReviewsContent className='reviews-content'> 
           <strong>Internat reviews</strong>
            <Table basic='very'>
                ...
                {!props.isEditable ? (
                    <Table.Row> 
                        ...
                        <Table.Cell>{edit.date_one}</Table.Cell>
                    </Table.Row>
                ) : <Table.Row>
                ...
                <Table.Row> 
                    ...
                    <Table.Cell>{edit.date_two}</Table.Cell>
                </Table.Row>
                ) : <Table.Row>
                ...
                <Table.Row> 
                    ...
                    <Table.Cell>{edit.date_three}</Table.Cell>
                </Table.Row>
                ) : <Table.Row>
            ...
            <Link to ='/proposals'><strong style={{color:'black'}}>See more reviews</strong></Link>
        </ReviewsContent>  
    )
}